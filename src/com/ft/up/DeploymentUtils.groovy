...
class DeploymentUtils {
  ...
  private static String CREDENTIALS_DIR = "credentials"
  private static String K8S_CLI_IMAGE = "coco/k8s-cli-utils:update-helm"

  static Map<String, String> envToApiServerMap = [
      "xp"  : "https://k8s-delivery-upp-eu-api.ft.com",
      "test": "https://k8s-delivery-upp-eu-api.ft.com"
  ]

  static String HELM_CONFIG_FOLDER = "helm"
